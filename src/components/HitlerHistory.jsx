      ...
      {tab === 'books' && (
        <div className="hh-section">
          {[
            ...
            {
              icon: '🌍',
              title: 'Hitler — "The New World Order"',
              text: 'Hitler skrev selv en tekst/bog med titlen "The New World Order" — et faktum som næsten ingen kender til.\n\nDette er IKKE Mein Kampf og IKKE Zweites Buch. Det er et separat skrift der beskriver hans vision for verdensordenen — og som konspirationsteoretikere peger på som bevis for at han ikke blot var en nationalist, men en aktør i et langt større globalt spil.\n\nAt bogens TITEL er "New World Order" er bemærkelsesværdigt — samme frase bruges af Bush Sr., Kissinger, og den globalistiske elite til at beskrive deres mål for en verdensregering.\n\nSpørgsmålet: Var Hitler IMOD den globale verdensorden — eller var han et INSTRUMENT for den?\n\nEn "kontrolleret opposition" der tjente til at legitimere:\n• FN (oprettet 1945)\n• IMF og Verdensbanken (oprettet 1944)\n• Staten Israel (oprettet 1948)\n• NATO (oprettet 1949)\n• Den Kolde Krig som permanent krigsøkonomi\n\nAlt dette skete inden for 5 år efter krigen. Infrastrukturen var klar. Man ventede bare på begivenheden.',
            },
            {
              icon: '⚡',
