...
const ITEMS = [
  ...
  { path:'/modern-slavery', icon:'⛓', name:'Det Moderne Slavesystem',    desc:'Rockefellers plan · Gæld som lænker · Din tid stjæles · Frakobling fra Gud · Hvad Jesus lærte', color:'#cc5555' },
