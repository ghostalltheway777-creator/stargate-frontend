...
const ITEMS = [
  { path:'/freq-convert',   icon:'🎵', name:'432 Hz Konverter',        desc:'Konverter musik fra 440→432 Hz · YouTube · SoundCloud · MP3 · Rockefeller historien', color:'#50c890' },
  { path:'/ancient-medicine',icon:'🌿', name:'AI Natur-Doktor',         desc:'Verdens bedste naturlæge · Dr. Sebi · Ancient medicine · CIA kure · Healing', color:'#50aa50' },
  { path:'/food-scanner',   icon:'📱', name:'Food Scanner',            desc:'Scan stregkode · Seed oils · E-numre · Dr. Sebi analyse · Se sandheden', color:'#50cc80' },
  ...
  { path:'/hitler-history', icon:'📖', name:'Hitler — Den Anden Side', desc:'WWI Jernkors · Tysland 1933-39 · Anschluss · Polen/Danzig · Frimureri · New World Order bogen', color:'#9a7a3a' },
  { path:'/rothschild',     icon:'🏦', name:'Rothschild & Rockefeller', desc:'Centralbanker · Balfour · Begge sider af krige · David Rockefeller · Trilateral Commission', color:'#7a5aaa' },
  { path:'/sport-circus',   icon:'🏟', name:'Sport · Reality · Cirkus',   desc:'Panem et Circenses · Super Bowl ritualer · Reality TV · Gaming · Din tid stjæles', color:'#60aa60' },
  { path:'/modern-slavery', icon:'⛓️', name:'Det Moderne Slavesystem',    desc:'Rockefellers plan · Gæld som lænker · Din tid stjæles · Frakobling fra Gud · Hvad Jesus lærte', color:'#cc5555' },
  { path:'/roman-empire',   icon:'🦅', name:'USA — Det Moderne Romerrige', desc:'Rom→Byzans→England→USA · Greater America · 56 stjerner · Musk & Teknokratiet · WEF', color:'#cc9933' },
  { path:'/media',          icon:'📡', name:'Verdens Medier',             desc:'Ritzau · 6 selskaber · BlackRock · Operation Mockingbird · EU propaganda · Spot det selv', color:'#5090bb' },
  { path:'/hollywood',      icon:'🎬', name:'Hollywood & Tell-A-Vision', desc:'TV-programmering · Baal-ritualer · Operation Blue Beam · Alien-programmering · Symboler', color:'#cc3355' },
  ...
  { path:'/covid',          icon:'🦠', name:'COVID-19 Scam',          desc:'William Shakespeare · mRNA · Gates retssag · Hanta · Epstein distraktion', color:'#cc4444' },
